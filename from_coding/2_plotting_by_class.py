...
def plot_all_labels(grouping, stats_dictionary, bands_list, bad_bands_list):
    '''
...
spectra = pd.read_csv(r"C:\Users\s4770224\Documents\coding\Spectral_analysis\Combined_analysis\Resampled\asd_MEL_NZ_TAS_spectra.csv").select_dtypes("float")
labels = pd.read_csv(r"C:\Users\s4770224\Documents\coding\Spectral_analysis\Combined_analysis\New_reflectance_labels.csv")

bands, bad_bands, stats_dict = prep_spectra_for_plotting("order", targets_subset = "all", sensor = "asd")
plot_all_labels('order', stats_dict, bands, bad_bands)
