...
sen2 = pd.read_csv(r'Combined_analysis\Resampled\sentinel_2.csv', index_col=[0])
...
lan9 = pd.read_csv(r'Combined_analysis\Resampled\landsat_9.csv', index_col=[0])
lan9 = lan9.drop(["Class", "setup", "site"], axis = 1)
lan9 = lan9.dropna(axis = 1, how = "any")
sks = pd.read_csv(r'Combined_analysis\Resampled\skysat.csv', index_col=[0])
sks = sks.drop(["Class", "setup", "site"], axis = 1)
sks = sks.dropna(axis = 1, how = "any")
sup = pd.read_csv(r'Combined_analysis\Resampled\superdove.csv', index_col=[0])
sup = sup.drop(["Class", "setup", "site"], axis = 1)
sup = sup.dropna(axis = 1, how = "any")
dov = pd.read_csv(r'Combined_analysis\Resampled\dove.csv', index_col=[0])
